...
Networks can be classified based on their **size, coverage area, and purpose**.
...
| :---------: | --------------------------- | --------------------------- | ----------------------------- |
|  📱 **PAN** | Personal Area Network       | Very small area             | Phone connected to smartwatch |
|  🏠 **LAN** | Local Area Network          | Home, office, building      | Office network                |
| 📶 **WLAN** | Wireless Local Area Network | Local area using Wi-Fi      | Home Wi-Fi                    |
|  🏫 **CAN** | Campus Area Network         | Multiple buildings / campus | University network            |
|  🌆 **MAN** | Metropolitan Area Network   | City or large town          | City-wide network             |
|  🌍 **WAN** | Wide Area Network           | Countries / continents      | Internet                      |
|  🌐 **GAN** | Global Area Network         | Worldwide                   | Global corporate network      |
...
PAN → LAN → CAN → MAN → WAN → GAN
 ↓     ↓     ↓     ↓     ↓     ↓
Person Local Campus City  Wide  Global
```
---

...
A **botnet** is a network of computers or other internet-connected devices that have been compromised and can be controlled by an attacker. A group of multiple infected devices that are remotely controlled is often used to generate large volumes of traffic.

...
> **Safety Note:** All security testing and analysis must be performed only on systems, applications, malware samples, and environments for which you have explicit authorization. Malware analysis must be performed in isolated or controlled environments to avoid risks to personal systems, networks, or data.
...
The organization has a visible public business and digital presence. However, claims relating to placements, outcomes, reputation, infrastructure, and privacy should be independently verified when used in formal reporting.
...
> **Ethical Requirement:** Perform all practical security testing only in authorized environments. The purpose of these activities is to understand, detect, document, and reduce cybersecurity risks while staying within legal and ethical boundaries.
